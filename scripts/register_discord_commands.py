...
This script registers the four Phase-1 commands (``/alert create``,
``/alert list``, ``/alert run``, ``/alert test``) with Discord's REST API
for a specific guild. Run it once after creating your bot, and re-run
whenever you change the command schemas.
